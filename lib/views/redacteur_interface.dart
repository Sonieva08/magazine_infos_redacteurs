...
class _RedacteurInterfaceState extends State<RedacteurInterface> {
  ...
  // TODO 1 : 3 TextEditingController (nom, prenom, email)

  // TODO 2 : List<Redacteur> _redacteurs (vide au départ)
...
Future<void> _modifierRedacteur(Redacteur redacteur) async {
  final TextEditingController nomCtrl = TextEditingController(text: redacteur.nom);
  final TextEditingController prenomCtrl = TextEditingController(text: redacteur.prenom);
  final TextEditingController emailCtrl = TextEditingController(text: redacteur.email);
...
Future<void> _ajouterRedacteur() async {
  ...
  if (nom.isEmpty || prenom.isEmpty || email.isEmpty) {
    return; // TODO : afficher un message d'erreur (on verra le SnackBar après)
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Padding(
        ...
        child: Column(
          children: [
            // TODO 3 : 3 TextField reliés aux contrôleurs
            TextField(
            ...
            // TODO 4 : ElevatedButton "Ajouter un Rédacteur"
            ...
            // TODO 5 : Expanded + ListView.builder affichant _redacteurs
